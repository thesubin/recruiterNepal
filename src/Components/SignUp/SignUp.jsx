...
const SignUp=()=> {
    return (
      <div className="w-full h-full  flex items-center bg-gradient-to-r from-amber-600 to-[#002202] justify-center ">
        ...
        < div className='max-h-[90vh]  overflow-y-scroll py-10'>
